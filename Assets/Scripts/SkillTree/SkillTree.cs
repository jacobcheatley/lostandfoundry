...
public static class SkillTree
{
    public static readonly Dictionary<SkillID, Skill> skills = new Dictionary<SkillID, Skill> {
        ...
        { SkillID.CameraSize2, new Skill(SkillID.HookDuration3, "Camera Size +1", "TODO DESC", "", 2500) },
        { SkillID.Value1, new Skill(SkillID.ValuablesRadar, "Value +25%", "TODO DESC", "", 5000) },
        { SkillID.Value2, new Skill(SkillID.Value1, "Value +25%", "TODO DESC", "", 10000) },
        ...
        { SkillID.HookSpeed3, new Skill(SkillID.TripleShot, "Hook Speed +1", "TODO DESC", "", 2000) },
        ...
        { SkillID.SeptaShot, new Skill(SkillID.PentaShot, "Septa Shot", "TODO DESC", "", 15000) },
        { SkillID.ValuablesRadar, new Skill(SkillID.HookDuration2, "Valuables Radar", "TODO DESC", "", 5000) },
        { SkillID.SlowerSwingSpeed, new Skill(SkillID.ValuablesRadar, "Slower Swing Speed", "TODO DESC", "", 5000) },
        { SkillID.TargetedLaunch, new Skill(SkillID.SlowerSwingSpeed, "Targeted Launch", "TODO DESC", "", 10000) },
        { SkillID.Redirect, new Skill(SkillID.ValuablesRadar, "Targeted Redirect", "TODO DESC", "", 10000) },
        { SkillID.HomingExtraShots, new Skill(SkillID.HookSpeed3, "Homing Extra Shots", "TODO DESC", "", 30000) },
