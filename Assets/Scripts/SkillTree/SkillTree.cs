...
public static class SkillTree
{
    public static readonly Dictionary<SkillID, Skill> skills = new Dictionary<SkillID, Skill> {
        ...
        { SkillID.HookSpeed2, new Skill(SkillID.LaunchAgain1, "Hook Speed +1", "TODO DESC", "", 100) },
        { SkillID.HookSpeed3, new Skill(SkillID.TripleShot, "Hook Speed +1", "TODO DESC", "", 250) },
        { SkillID.HookSpeed4, new Skill(SkillID.None, "Hook Speed +1", "TODO DESC", "", 200) },
        { SkillID.LaunchAgain1, new Skill(SkillID.HookSpeed1, "Launch Again", "TODO DESC", "", 100) },
        { SkillID.LaunchAgain2, new Skill(SkillID.LaunchAgain1, "Launch Again Again", "TODO DESC", "", 300) },
        { SkillID.LaunchAgain3, new Skill(SkillID.LaunchAgain2, "Launch Again Again Again", "TODO DESC", "", 1000) },
        { SkillID.Pierce1, new Skill(SkillID.None, "Pierce +1", "TODO DESC", "", 100) },
        { SkillID.Pierce2, new Skill(SkillID.Pierce1, "Pierce +1", "TODO DESC", "", 250) },
        { SkillID.Pierce3, new Skill(SkillID.Pierce2, "Pierce +1", "TODO DESC", "", 750) },
        { SkillID.Pierce4, new Skill(SkillID.Pierce3, "Pierce +1", "TODO DESC", "", 1500) },
